...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn("px-3 py-2.5 text-xs data-[inset]:pl-8", className)}
      {...props}
    />
  );
}
...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        "btn btn--ghost px-3 py-2 text-sm group/dropdown-menu-item relative outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-[inset]:pl-8 w-full",
        className,
      )}
      {...props}
    />
